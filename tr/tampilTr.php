...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Transaksi</a> </div>
    <h1>Transaksi</h1>
  </div>
            ...
            <table class="table table-bordered data-table">
              <thead>
                <tr>
                  ...
                  <th colspan="2">
                    <a href="tambahTr.php" class="btn btn-info"><i class="icon-plus"></i> Tambah</a>
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td style="text-align: center;">
                    <?php
                    echo "<a href='editTr.php?id=$r[id]' class='btn btn-warning'><i class='icon-edit'></i> Edit</a>";
                    ?>
                  </td>
                  <td style="text-align: center;">  
                    <?php
                    echo "<a href='prosesHapus.php?id=$r[id]' class='btn btn-danger'><i class='icon-remove'></i> Hapus</a>";
                    ?>
                  </td>
