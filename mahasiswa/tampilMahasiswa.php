...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Mahasiswa</a> </div>
    <h1>Mahasiswa</h1>
  </div>
            ...
            <table class="table table-bordered data-table">
              <thead>
                <tr>
                  ...
                  <th>Alamat</th>
                  <th colspan="2">
                    <a href="tambahMahasiswa.php" class="btn btn-info"><i class="icon-plus"></i> Tambah</a>
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td style="text-align: center;">
                    <?php
                    echo "<a href='editMahasiswa.php?nim=$r[nim]' class='btn btn-warning'><i class='icon-edit'></i> Edit</a>";
                    ?>
                  </td>
                  <td style="text-align: center;">  
                    
                    <?php
                    echo "<a href='prosesHapus.php?nim=$r[nim]' class='btn btn-danger'><i class='icon-remove'></i> Hapus</a>";
                    ?>
