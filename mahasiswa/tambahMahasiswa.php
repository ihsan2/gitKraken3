...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Mahasiswa</a> <a href="#" class="current">Tambah Mahasiswa</a></div>
          ...
          <div class="widget-content nopadding">
            <form action="prosesTambah.php" method="post" class="form-horizontal">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="nim" class="span11" placeholder="NIM" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Nama Mahasiswa :</label>
                <div class="controls">
                  <input type="text" name="nama" class="span11" placeholder="Nama Mahasiswa" />
                </div>
              </div>
               <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="angkatan" class="span11" placeholder="Angkatan" />
                </div>
              </div>
              <div class="control-group">
