...
include '../koneksi.php';
  ...
  $nim          = $_GET['nim'];
  $mahasiswa    = mysqli_query($konek, "SELECT * FROM tb_mahasiswa WHERE nim='$nim'");
  $r            = mysqli_fetch_array($mahasiswa);
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a><ul>
    ...
    <li> <a href="tampilMahasiswa.php"><i class="icon icon-signal"></i> <span>Mahasiswa</span></a> </li>
...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Mahasiswa</a> <a href="#" class="current">Edit Mahasiswa</a></div>
          ...
          <div class="widget-content nopadding">
            <form action="prosesEdit.php" method="post" class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="nim" class="span11" placeholder="NIM" value="<?php echo $r['nim']; ?>" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Nama Mahasiswa :</label>
                <div class="controls">
                  <input type="text" name="nama" class="span11" placeholder="Nama Mahasiswa" value="<?php echo $r['nama']; ?>"/>
                </div>
              </div>
               <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="angkatan" class="span11" placeholder="Angkatan" value="<?php echo $r['angkatan']; ?>"/>
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="form-actions">
                ...
                <a href="tampilMahasiswa.php" class="btn btn-danger">Kembali</a>
              </div>
            </form>
          </div>
        </div>
