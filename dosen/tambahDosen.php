...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Dosen</a> <a href="#" class="current">Tambah Dosen</a></div>
          ...
          <div class="widget-content nopadding">
            <form action="prosesTambah.php" method="post" class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="nama" class="span11" placeholder="Nama Dosen" />
                </div>
              </div>
               <div class="control-group">
